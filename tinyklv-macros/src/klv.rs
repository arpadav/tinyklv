...
pub(crate) struct StructAttrs {
    pub key_dec: Option<syn::Path>,
    pub key_enc: Option<syn::Path>,
    pub len_dec: Option<syn::Path>,
    pub len_enc: Option<syn::Path>,
    pub default_dec: HashMap<std::any::TypeId, syn::Path>,
    pub default_enc: HashMap<std::any::TypeId, syn::Path>,
}
