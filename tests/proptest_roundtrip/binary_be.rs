//! Property-based roundtrip tests for big-endian binary codecs
//!
...
//! big-endian codec satisfies `decode(encode(v)) == v` for arbitrary inputs
//! Also includes output-length invariants, `to_be_bytes` match properties,
//! and single-byte encoder assertions
//!
//! Author: aav
// --------------------------------------------------
// external
