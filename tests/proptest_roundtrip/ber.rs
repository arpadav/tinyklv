...
proptest! {
    ...
    fn ber_length_roundtrip_u32_range(val in 0u32..u32::MAX) {
        let mut encoded = Vec::new(); BerLength::new(val as u64).encode_value(&mut encoded);
...
proptest! {
    ...
    fn ber_length_fn_api_roundtrip(val in 0u32..u32::MAX) {
        let mut encoded = Vec::new(); tinyklv::enc::ber::ber_length(val as u64, &mut encoded);
...
proptest! {
    ...
    fn ber_oid_roundtrip_u32_range(val in 1u32..u32::MAX) {
        let mut encoded = Vec::new(); BerOid::new(val as u64).encode_value(&mut encoded);
...
proptest! {
    ...
    fn ber_oid_fn_api_roundtrip(val in 1u32..u32::MAX) {
        let mut encoded = Vec::new(); tinyklv::enc::ber::ber_oid(val as u64, &mut encoded);
