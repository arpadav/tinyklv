...
pub const KLV_2_PLATFORM_HEADING: f64 = 360.0 / 65535.0;
pub const SFT_2_PLATFORM_HEADING: f64 = 65535.0 / 360.0;
pub const KLV_2_PLATFORM_PITCH: f64 = 40.0 / 65534.0;
pub const SFT_2_PLATFORM_PITCH: f64 = 65534.0 / 40.0;
pub const KLV_2_PLATFORM_ROLL: f64 = 100.0 / 65534.0;
pub const SFT_2_PLATFORM_ROLL: f64 = 65534.0 / 100.0;
pub const KLV_2_SENSOR_TRUE_ALT_P1: f64 = 19900.0 / 65535.0;
pub const SFT_2_SENSOR_TRUE_ALT_P1: f64 = 65535.0 / 19900.0;
pub const SENSOR_TRUE_ALT_OFFSET_P2: f64 = 900.0;
pub const SFT_2_SENSOR_HVFOV: f64 = 65535.0 / 180.0;
pub const KLV_2_SENSOR_HVFOV: f64 = 180.0 / 65535.0;
...
pub const SFT_2_TARGET_WIDTH: f64 = 65535.0 / 10_000.0;
pub const KLV_2_TARGET_WIDTH: f64 = 10_000.0 / 65535.0;
...
pub(crate) fn to_platform_heading(input: &mut &[u8]) -> winnow::PResult<f64> {
    tinyklv::scale_fn!(input, tinyklv::codecs::binary::dec::be_u16, f64, KLV_2_PLATFORM_HEADING)
}
...
pub(crate) fn to_sensor_hvfov(input: &mut &[u8]) -> winnow::PResult<f64> {
    tinyklv::scale_fn!(input, tinyklv::codecs::binary::dec::be_u16, f64, KLV_2_SENSOR_HVFOV)
}

#[inline(always)]
pub(crate) fn to_sensor_rel_azm_rll_angle(input: &mut &[u8]) -> winnow::PResult<f64> {
    tinyklv::scale_fn!(input, tinyklv::codecs::binary::dec::be_u32, f64, KLV_2_SENSOR_REL_AZM_RLL_ANGLE)
}

#[inline(always)]
pub(crate) fn to_sensor_rel_elv_angle(input: &mut &[u8]) -> winnow::PResult<f64> {
    tinyklv::scale_fn!(input, tinyklv::codecs::binary::dec::be_i32, f64, KLV_2_SENSOR_REL_ELV_ANGLE)
}

#[inline(always)]
pub(crate) fn to_slant_range(input: &mut &[u8]) -> winnow::PResult<f64> {
    tinyklv::scale_fn!(input, tinyklv::codecs::binary::dec::be_u32, f64, KLV_2_SLANT_RANGE)
}

#[inline(always)]
pub(crate) fn to_target_width(input: &mut &[u8]) -> winnow::PResult<f64> {
    tinyklv::scale_fn!(input, tinyklv::codecs::binary::dec::be_u16, f64, KLV_2_TARGET_WIDTH)
}