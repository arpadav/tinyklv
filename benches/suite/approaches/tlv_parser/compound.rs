//! tlv_parser x compound record: build a nested tree (a constructed coordinate sub-tree
...
/// [`TlvParser`] implementation of [`Codec`] for [`Compound`]
impl Codec<Compound> for TlvParser {
