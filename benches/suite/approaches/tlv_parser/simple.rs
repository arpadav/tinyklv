//! tlv_parser x simple record: build a constructed tag `0x21` wrapping eight primitive
...
/// [`TlvParser`] implementation of [`Codec`] for [`Simple`]
impl Codec<Simple> for TlvParser {
