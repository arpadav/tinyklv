//! rust-protobuf x flat record: populate the generated `Telemetry` (with
...
/// [`RustProtobuf`] implementation of [`Codec`] for [`Telemetry`]
impl Codec<Telemetry> for RustProtobuf {
    ...
    fn decode(body: &[u8]) -> Option<Telemetry> {
        ...
        // --------------------------------------------------
        let m = generated::Telemetry::parse_from_bytes(body).ok()?;
        // --------------------------------------------------
