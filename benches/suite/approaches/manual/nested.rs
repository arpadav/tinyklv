//! manual x nested record: the flat machine plus a nested coordinate sub-parser and the
...
/// [`Manual`] implementation of [`Codec`] for [`Platform`]
impl Codec<Platform> for Manual {
