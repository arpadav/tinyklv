//! manual x flat record: hand-pushed key/length/value triples to encode, a hand-rolled
...
/// [`Manual`] implementation of [`Codec`] for [`Telemetry`]
impl Codec<Telemetry> for Manual {
