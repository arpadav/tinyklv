...
macro_rules! as_usize {
    ($parser:ident) => { paste::paste! {
        #[inline(always)]
        #[doc = concat!(" [usize] wrapper for [winnow::binary::", stringify!($parser), "] with implied generics <&[u8], winnow::error::ContextError>")]
        #[doc = ""]
        ...
        #[inline(always)]
        #[doc = concat!(" [usize] wrapper for [winnow::binary::be_", stringify!($parser), "] with implied generics <&[u8], winnow::error::ContextError>")]
        #[doc = ""]
        ...
        #[inline(always)]
        #[doc = concat!(" [usize] wrapper for [winnow::binary::le_", stringify!($parser), "] with implied generics <&[u8], winnow::error::ContextError>")]
        #[doc = ""]
